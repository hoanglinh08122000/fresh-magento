...
class Save extends \Table\Table\Controller\Adminhtml\Items
{
            ...
            try {
                ...
                if(isset($_FILES['image']['name']) && $_FILES['image']['name'] != '') {
                    try{
                        ...
                        $destinationPath = $mediaDirectory->getAbsolutePath('table/table');
                        ...
                        $imagePath = 'table/table'.$result['file'];
                ...
                if ($this->getRequest()->getParam('back')) {
                    $this->_redirect('table_table/*/edit', ['id' => $model->getId()]);
                    return;
                }
                ...
                if (!empty($id)) {
                    $this->_redirect('table_table/*/edit', ['id' => $id]);
                } else {
                    $this->_redirect('table_table/*/new');
                }
                return;
            } catch (\Exception $e) {
                ...
                $this->_redirect('table_table/*/edit', ['id' => $this->getRequest()->getParam('id')]);
                return;
            }
        }
        $this->_redirect('table_table/*/');
